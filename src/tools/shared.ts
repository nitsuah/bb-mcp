...
export const searchCourseMaterialsSchema = {
  ...
  description: 'Full-text search across course content. Optionally scoped to one course.',
  inputSchema: {
    type: 'object',
    properties: {
      caller_identity: { type: 'object', required: ['userId', 'role'] },
      query: { type: 'string', description: 'Search query' },
      courseId: { type: 'string', description: 'Limit search to this course (optional)' },
    },
